...
import { Linkedin as LinkedInLogo } from "lucide-react";
    ...
    <div className="relative max-w-4xl mx-auto px-4 [&_a]:no-underline">
      ...
      <div className="mt-16 border-t border-white/10 pt-12">
        ...
        <div className="grid grid-cols-2 place-items-center gap-6 sm:gap-8 md:gap-12 max-w-3xl mx-auto mt-6">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full mb-4 overflow-hidden border-2 border-sky-500/40">
              <img
            ...
            <p className="text-sky-500 text-sm mt-1"> CEO</p>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sky-500 text-sm mt-1">CMO</p>
            <div className="flex space-x-3 mt-0">
              <a
      ...
      <div className="mt-16 border-t border-white/10 pt-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 place-items-center gap-6 sm:gap-8 md:gap-12 max-w-3xl mx-auto mt-6">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full overflow-hidden mb-4 border-2 border-sky-500/40">
              <img
            ...
            <p className="text-sky-500 text-sm mt-1">Co-Founder & CEO at Cerbos</p>
            <div className="flex space-x-3 mt-0">
              <a
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sky-500 text-sm mt-1">Co-Founder at Ubicloud</p>
            <div className="flex space-x-3 mt-0">
              <a
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sky-500 text-sm mt-1">CEO at Actioner</p>
            <div className="flex space-x-3 mt-0">
              <a
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-3 sm:gap-4 max-w-4xl mx-auto mt-6">
          {loading
            ...
            : contributors?.map((contributor) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-sky-500/40 mb-2 group-hover:border-sky-500 transition-all">
                    <img
          ...
          {loading ? (
            ...
            <>
              {recentStargazers?.slice(0, 9).map((stargazer) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-sky-500/30 group-hover:border-sky-500 transition-all">
                    <img
