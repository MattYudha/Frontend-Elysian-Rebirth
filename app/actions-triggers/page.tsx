...
const features = [
  {
    ...
    image: "/cdn/website/triggers-actions/actions.png",
  },
  {
    ...
    image: "/cdn/website/triggers-actions/target.png",
  },
  {
    ...
    image: "/cdn/website/triggers-actions/dashboard.png",
  },
];
...
export default function ActionsTriggersPage() {
  return (
    <ProductPageTemplate
      ...
      heroImage="/cdn/website/triggers-actions/hero.png"
      features={features}
