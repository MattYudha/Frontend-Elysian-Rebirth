...
function BlockchainVerifyContent() {
    ...
    <!-- Header Section -->
    <text x="300" y="90" font-family="'Courier New', monospace" font-size="12" font-weight="900" fill="#F59E0B" letter-spacing="4" text-anchor="middle">ELYSIAN VERIFIABLE TRUST</text>
    <text x="300" y="130" font-family="'Segoe UI', Helvetica, sans-serif" font-size="24" font-weight="900" fill="#FFFFFF" letter-spacing="2" text-anchor="middle">SERTIFIKAT AUDIT DIGITAL</text>
    ...
    <g transform="translate(100, 520)">
        ...
        <text x="200" y="42" font-family="'Segoe UI', sans-serif" font-size="16" font-weight="900" fill="#06B6D4" text-anchor="middle" letter-spacing="1">DOKUMEN 100% AMAN &amp; LAYAK</text>
        <text x="200" y="70" font-family="'Segoe UI', sans-serif" font-size="12" font-weight="bold" fill="#F59E0B" text-anchor="middle" letter-spacing="0.5">KEPATUHAN ANGGARAN TERVERIFIKASI ON-CHAIN</text>
    </g>
