...
import { UseCaseAnimation } from "@/components/usecase-animation";
import { ResponsiveSupervisorFlow } from "@/components/usecase-supervisor-flow/responsive-wrapper";
...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-sky-600/20 text-sky-400 border border-sky-500/20 hover:bg-sky-600/30 shadow-lg hover:shadow-xl",
    secondary:
      "bg-transparent text-sky-400 border border-sky-500/20 hover:bg-sky-600/20",
  };
...
const defaultHowItWorks = [
  ...
  {
    step: 4,
    title: "Observe in ElysianOps",
    description: "Trace decisions, tool calls, tokens, and performance; refine safely.",
  },
];

export default function UseCaseClient({ useCase }: UseCasePageProps) {
  return (
    <div className="flex flex-col min-h-screen">
      <LandingNavbar forceDark={true} />

      <main className="flex-1 bg-[#050507] relative overflow-hidden pt-28 lg:pt-36">
        <DotPattern dotColor="#94a3b8" dotSize={1.2} spacing={20} className="opacity-[0.25]" />
        ...
        <Section className="relative">
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              ...
              >
                <div className="mb-4">
                  <span className="text-[#0ea5e9] font-semibold text-lg">
            ...
            >
              ...
              <div className="mb-12">
                ...
                <p className="max-w-3xl landing-md:text-xl landing-xs:text-md text-gray-400 mb-0">
                  Design AI agents that match your workflows with Elysian
                </p>
              </div>
                        ...
                        {useCase.capabilities.map((capability, index) => (
                          ...
                          >
                            <div className="relative mr-3 mt-0.5 flex-shrink-0">
                              <div className="absolute inset-0 bg-sky-500/20 rounded-full blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                              <ArrowRightIcon className="w-5 h-5 text-sky-400 relative z-10" />
                            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {useCase.features.map((feature, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="relative h-full bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-xl border border-solid border-sky-500/30 rounded-2xl p-5 overflow-hidden">
                          ...
                          <div className="relative z-10">
                            <h3 className="text-base  text-white mb-3 flex items-center">
                              <FeatureIcon className="w-5 h-5 text-sky-400 mr-2 flex-shrink-0" />
                              {feature.title}
                            </h3>
                    ...
                    >
                      ...
                      <div className="relative">
                        <h3 className="text-lg font-bold text-white mb-2 flex items-center">
                          <span className="text-sky-400 font-bold mr-2">{step.step}.</span>
                          {step.title}
                        </h3>
                        {/* Underline accent */}
                        <div className="w-full h-[1px] bg-sky-500/30 mb-4" />
                  ...
                  {(useCase.howItWorks || defaultHowItWorks).map((step, index) => (
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="w-full h-[1px] bg-sky-500/30 mb-3" />
          ...
          <Section className="relative">
            <Container className="relative z-10">
              ...
              >
                ...
                <div className="mb-12">
                  <h2 className="mt-1 landing-xs:text-2xl landing-md:text-4xl landing-xs:mb-2 landing-md:mb-4 landing-xs:font-bold landing-md:font-extrabold text-white sm:text-5xl sm:tracking-tight">
                    <span className="text-sky-500">AI Agent Ideas</span> You Can Build
                  </h2>
                  <p className="max-w-3xl landing-md:text-xl landing-xs:text-md text-gray-400">
                    Here are examples of agents you can design with Elysian, tailored to your
                    workflows and stack.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {useCase.exampleAgents.map((agent, index) => {
                    return (
                      ...
                      >
                        {/* Card content */}
                        <div className="relative h-full bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-xl border border-solid border-sky-500/30 rounded-2xl p-6 overflow-hidden">
                          {/* Animated background pattern */}
                  ...
                  <Link href="/tutorial/introduction" className="no-underline hover:no-underline">
                    <motion.div
                      initial={{ opacity: 0, y: 30, rotateX: -15 }}
                      animate={{ opacity: 1, y: 0, rotateX: 0 }}
                      transition={{
                    ...
                    >
                      <div className="relative h-full bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-xl border border-solid border-sky-500/30 rounded-2xl p-6 hover:bg-gradient-to-br hover:from-gray-900/95 hover:to-gray-950/95 transition-all">
                        <div className="relative z-10">
                          <h3 className="text-sm font-bold text-sky-400 mb-3 pr-8 flex items-center">
                            <span className="text-lg font-bold text-sky-400 mr-2">+</span>
                            Build Custom Agents
                          </h3>
          ...
          <Container className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="h-full bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-xl border border-solid border-sky-500/30 rounded-2xl p-6 md:p-8 overflow-hidden">
                  {/* Animated background pattern */}
                  <div className="absolute inset-0 opacity-5">
                    <div
                      className="absolute inset-0"
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    <h2 className="mt-1 text-lg landing-md:text-3xl landing-xs:mb-2 landing-md:mb-4 landing-xs:font-bold landing-md:font-extrabold text-white sm:text-5xl sm:tracking-tight flex items-center">
                      <ShieldCheckIcon className="w-5 h-5 md:w-7 md:h-7 text-sky-400 mr-2 md:mr-3" />
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6 md:mb-8">
                      {[
                        ...
                        <motion.div
                          ...
                          className="flex items-center bg-gradient-to-br from-sky-500/10 to-cyan-500/10 border border-solid border-sky-500/30 rounded-lg px-3 py-2 md:px-4 md:py-3"
                        >
                          <item.Icon className="w-4 h-4 md:w-5 md:h-5 text-sky-400 mr-2 md:mr-3 flex-shrink-0" />
                          <span className="text-xs md:text-sm font-medium text-sky-400">
                            {item.label}
                          </span>
                        </motion.div>
                      ))}
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="h-full bg-gradient-to-br from-sky-500/10 via-gray-900/90 to-gray-950/90 backdrop-blur-xl border-2 border-solid border-sky-400/40 rounded-2xl p-6 md:p-8 overflow-hidden">
                  {/* Animated background pattern */}
                  <div className="absolute inset-0 opacity-10">
                    <div
                      className="absolute inset-0"
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    <h2 className="mt-1 text-lg landing-md:text-3xl landing-xs:mb-2 landing-md:mb-4 landing-xs:font-bold landing-md:font-extrabold text-white sm:text-5xl sm:tracking-tight flex items-center">
                      <BoltIcon className="w-5 h-5 md:w-7 md:h-7 text-sky-400 mr-2 md:mr-3" />
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      <p className="max-w-3xl landing-md:text-xl landing-xs:text-md text-gray-400 mb-6 md:mb-10">
                        Join hundreds of teams building production AI agents with Elysian
                      </p>
                      ...
                      <div className="flex items-center text-xs md:text-sm">
                        <CheckCircleIcon className="w-4 h-4 text-sky-400 mr-2" />
