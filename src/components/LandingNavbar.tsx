                ...
                <div className="w-full h-full px-4 lg:px-6 flex justify-between lg:grid lg:grid-cols-3 items-center">
                    ...
                    <div className="flex justify-end items-center">
                        ...
                        >
                            ...
                            {/* Terminal Toggle - Desktop (Hidden on medium screens) */}
                            <button
                                onClick={() => setShowTerminal && setShowTerminal(!showTerminal)}
                                className={cn(
                                    "hidden xl:flex p-2 rounded-full transition-all duration-200",
                                    showTerminal
                                ...
                                <div className="mt-auto pt-8">
                                    <Button asChild className="w-full h-14 rounded-lg bg-sky-500 hover:bg-sky-400 text-black font-semibold text-lg transition-all active:scale-[0.98]">
                                        <Link href="/register" onClick={() => setMobileMenuOpen(false)}>
                                            {t.landingNav.actions.startFree || "Log in to Elysian"}
                                        </Link>
                                    </Button>
                                </div>
                            </div>
