...
export function OAuthButton({
    ...
    return (
        <Button
            ...
            className={cn(
                "w-full bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm",
        ...
        >
            {isLoading ? (
                ...
                isGoogle ? (
                    ...
                    <GitHubSVG className="mr-2 h-5 w-5 fill-slate-900 dark:fill-white" />
                )
            )}
