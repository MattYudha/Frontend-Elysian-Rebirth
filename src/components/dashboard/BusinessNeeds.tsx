    ...
    return (
        <div className="pt-8 pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Elysian Iner Card */}
                <div className="group bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 relative overflow-hidden">
