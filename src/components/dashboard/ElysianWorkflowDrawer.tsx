...
export function ElysianWorkflowDrawer({ isOpen, onClose }: ElysianWorkflowDrawerProps) {
    ...
    const workflowSteps = [
        ...
        },
        {
            ...
            details: "Tiga agen AI (Auditor, Compliance, Manager) melakukan negosiasi otonom. Auditor mencari kesenjangan harga pada **Nemesis DB (9,7 Juta Row)**, Compliance memverifikasi kecocokan regulasi, dan Manager mengambil konsensus.",
            icon: Bot,
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6 no-scrollbar">
                            ...
                            <div className="p-4 rounded-xl border border-blue-500/20 bg-gradient-to-r from-blue-500/5 to-indigo-500/5 text-xs text-slate-650 dark:text-slate-350 leading-relaxed space-y-1.5 shadow-sm">
                                ...
                                <p>
                                    Elysian menggabungkan AI Swarm otonom, database standar harga <strong>Nemesis (9,7 Juta Row)</strong>, dan validitas hukum berbasis <strong>Blockchain</strong> ke dalam satu aliran terintegrasi penuh.
                                </p>
                            </div>
