...
import { LinkedInLogo } from "@/components/elysian/logos/linkedin";
import { XLogo } from "@/components/elysian/logos/x";
...
export function Manifesto() {
  ...
  return (
    <div className="relative max-w-4xl mx-auto px-4 [&_a]:no-underline">
      ...
      <div className="mb-6">
        <h2 className="landing-xs:text-sm landing-md:text-lg landing-xs:mb-2 landing-md:mb-3 font-semibold text-sky-400 tracking-wide uppercase">
          About us
        </h2>
      ...
      <div className="flex flex-col space-y-4 max-w-4xl">
        ...
        <p className="text-[#dcdcdc] leading-relaxed">
          ...
          That's why we're building Elysian – to bring better clarity and best practices
      ...
      <div className="mt-16 border-t border-white/10 pt-12">
        <h2 className="landing-xs:text-sm landing-md:text-lg text-center landing-xs:mb-2 landing-md:mb-3 font-semibold text-sky-400 tracking-wide uppercase">
          Team
        </h2>
        ...
        <div className="grid grid-cols-2 place-items-center gap-6 sm:gap-8 md:gap-12 max-w-3xl mx-auto mt-6">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full mb-4 overflow-hidden border-2 border-sky-400/40">
              <img
            ...
            <p className="text-sky-400 text-sm mt-1"> CEO</p>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full mb-4  overflow-hidden border-2 border-sky-400/40">
              <img
                src="/cdn/website/team/necati.png"
                alt="Necati Ozmen"
                className="w-full h-full object-cover"
              />
            </div>
            <span className="text-white font-medium text-lg">Necati Ozmen</span>
            <p className="text-sky-400 text-sm mt-1">CMO</p>
            <div className="flex space-x-3 mt-0">
              <a
      ...
      <div className="mt-16 border-t border-white/10 pt-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 place-items-center gap-6 sm:gap-8 md:gap-12 max-w-3xl mx-auto mt-6">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full overflow-hidden mb-4 border-2 border-sky-400/40">
              <img
            ...
            <p className="text-sky-400 text-sm mt-1">Co-Founder & CEO at Cerbos</p>
            <div className="flex space-x-3 mt-0">
              <a
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sky-400 text-sm mt-1">Co-Founder at Ubicloud</p>
            <div className="flex space-x-3 mt-0">
              <a
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sky-400 text-sm mt-1">CEO at Actioner</p>
            <div className="flex space-x-3 mt-0">
              <a
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-3 sm:gap-4 max-w-4xl mx-auto mt-6">
          {loading
            ...
            : contributors?.map((contributor) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-sky-400/40 mb-2 group-hover:border-sky-400 transition-all">
                    <img
                  ...
                  <span className="text-[#dcdcdc] text-xs group-hover:text-sky-400 transition-colors no-underline">
                    {contributor.login}
                  </span>
                </a>
              ))}
      ...
      <div className="mt-16 border-t border-white/10 pt-12">
        ...
        <p className="text-center max-w-2xl mx-auto landing-md:text-sm landing-xs:text-xs text-[#dcdcdc] mb-6">
          <span className="text-sky-400 font-semibold">{loading ? "..." : stars}</span> GitHub
          ...
          {loading ? (
            ...
            <>
              {recentStargazers?.slice(0, 9).map((stargazer) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-sky-400/30 group-hover:border-sky-400 transition-all">
                    <img
              ...
              <a
                ...
                className="group no-underline text-decoration-none"
              >
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-sky-400/30 group-hover:border-sky-400 transition-all bg-sky-400/20 flex items-center justify-center">
                  <div className="text-sky-400 font-semibold text-xs">+{stars - 9}</div>
                </div>
              </a>
            </>
          )}
