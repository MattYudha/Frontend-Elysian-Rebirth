...
import { AirtableLogo, GitHubLogo, GmailLogo, SlackLogo } from "@/components/elysian/logos";
...
>(({ className, children, label, description, type = "input", nodeId }, ref) => {
      ...
      <div className="relative">
        <div
          ...
          className={clsx(
            ...
            isActive && "bg-[#0f2d4a]/80 shadow-[0_0_15px_rgba(56,189,248,0.2)]",
            className,
          )}
        ...
        {description && isHovered && (
          <div className="absolute top-full mt-2 z-50 w-48 rounded-md bg-white dark:bg-[#0a1e36] border border-solid border-slate-200 dark:border-[#0f2d4a] p-3 shadow-lg text-xs text-slate-700 dark:text-gray-300">
            {description}
            {isActive && <div className="mt-1 text-sky-400">✓ Active in beat sequence</div>}
          </div>
        )}
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-center relative">
      {label && type === "core" && (
        <span className="text-xs mb-2 font-medium text-slate-700 dark:text-gray-300">{label}</span>
      )}
      <div
        ref={ref}
        className={clsx(
          ...
          type === "core"
            ? "border-sky-400 pt-1 mb-3 shadow-[0_0_30px_rgba(56,189,248,0.3)]"
            : "border-sky-400",
          type === "core" ? (isMobile ? "size-9" : "size-14") : "size-9",
          isActive && "bg-[#0f2d4a] shadow-[0_0_15px_rgba(56,189,248,0.5)]",
          className,
        )}
        data-type={type}
        onMouseEnter={() => setIsHovered(true)}
      ...
      {label && type === "module" && (
        <span className="mt-2 text-xs font-medium text-slate-700 dark:text-gray-300">{label}</span>
      )}
...
export function AgentsAnimation({ className }: { className?: string }) {
  ...
  // Core node
  const elysianAgentRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    ...
    for (const input of inputSequence) {
      const inputTimer = setTimeout(() => {
        ...
        // Start output beam when input reaches Elysian Agent
  ...
  useEffect(() => {
    // Start module interactions when the first particle reaches Elysian Agent
  ...
  return (
    <div
      className={clsx("relative flex flex-col w-full max-w-4xl h-[380px] md:h-[450px] items-center", className)}
      ref={containerRef}
    >
      <div className="relative flex justify-center items-center flex-1 w-full landing-xs:scale-[1] landing-md:scale-100 landing-xs:mt-12 landing-md:mt-0">
        ...
        <div className="absolute left-0 flex flex-col justify-center h-full space-y-4">
          ...
          <Node
            ...
            nodeId="apiCall"
          >
            <GitHubLogo className="h-5 w-5 text-slate-900 dark:text-white" />
          </Node>
        ...
        {/* Center column with Elysian Agent - Centered */}
        <div className="flex-1 flex justify-center items-center">
          ...
          >
            <div className="relative ">
              <div className="absolute inset-0 rounded-full bg-[#38bdf8] blur-md opacity-30 animate-pulse" />
              <Icons.lightning
                className={clsx("text-sky-400", isMobile ? "h-5 w-5" : "h-8 w-8")}
              />
            </div>
          </Node>
        </div>
        ...
        <div className="absolute right-0 flex flex-col justify-center h-full space-y-4">
          <Node
            ...
            nodeId="aiResponse"
          >
            <Icons.aiResponse className="h-4 w-4 text-sky-400" />
          </Node>
          ...
          <Node
            ...
            nodeId="automation"
          >
            <Icons.automation className="h-5 w-5 text-sky-400" />
          </Node>
          ...
          <Node
            ...
            nodeId="apiResponse"
          >
            <Icons.code className="h-5 w-5 text-sky-400" />
          </Node>
          ...
          <Node
            ...
            nodeId="webhookOut"
          >
            <Icons.integration className="h-5 w-5 text-sky-400" />
          </Node>
        </div>
      </div>
      ...
      {/* Elysian Agent to Module Container Beams */}
      {moduleInteractionActive && (
        <>
          {/* Elysian Agent to Module Container - Request */}
          <AnimatedBeam
            containerRef={containerRef}
            fromRef={elysianAgentRef}
            ...
            pathColor="rgba(56, 189, 248, 0.15)"
            pathWidth={2}
            className="animate-pulse-slow"
            pathType="curved"
            showParticles={true}
          ...
          {/* Module Container to Elysian Agent - Response */}
          <AnimatedBeam
            containerRef={containerRef}
      ...
      {/* Module nodes row below Elysian Agent */}
      <div
      ...
      >
        ...
        <Node
          ...
          nodeId="workflow"
        >
          <Icons.workflow className="h-4 w-4 text-sky-400" />
        </Node>
        <Node
          ref={llmRef}
          type="module"
          ...
          nodeId="llm"
        >
          <Icons.brain className="h-4 w-4 text-sky-400" />
        </Node>
        ...
        <Node
          ...
          nodeId="memory"
        >
          <Icons.database className="h-4 w-4 text-sky-400" />
        </Node>
        ...
        <Node
          ...
          nodeId="rag"
        >
          <Icons.search className="h-4 w-4 text-sky-400" />
        </Node>
        ...
        <Node
          ...
          nodeId="tools"
        >
          <Icons.tools className="h-4 w-4 text-sky-400" />
        </Node>
      </div>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 55%, rgba(56,189,248,0.12) 0%, rgba(56,189,248,0.04) 30%, transparent 65%)",
        }}
      />
    </div>
  );
