...
interface BannerButtonProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  children: React.ReactNode;
  color?: string;
}

export function BannerButton({ children, color = "bg-light-yellow", ...props }: BannerButtonProps) {
  return (
    <a
      href="#_"
