...
const getDifficultyBars = (level: number) => {
  ...
  return bars.map((bar) => (
    <div
      key={bar.id}
      className={`h-1.5 w-3 rounded-sm ${bar.active ? "bg-sky-500" : "bg-gray-600"}`}
    />
  ));
};
...
const AgentCapabilitiesMatrix = () => {
  ...
  return (
    <div className="my-4 rounded-lg border-2 border-sky-500 bg-gray-800 p-4 text-gray-100 shadow-lg">
      <h3 className="mb-3 mt-0 text-lg text-sky-300 font-semibold">
      ...
      <div className="relative">
        <button
          ...
          className="w-full flex items-center justify-between bg-sky-600 hover:bg-sky-700 text-white px-4 py-3 rounded-lg border border-sky-700 transition-colors duration-200"
        >
      ...
      {selectedCapability && (
        <div className="mt-4 rounded-lg border border-gray-600 bg-gray-700 p-4 text-gray-200">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <span className="text-base text-sky-300 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <h5 className="text-xs text-sky-200 font-medium mb-2">💡 Examples:</h5>
            ...
            <div>
              <h5 className="text-xs text-sky-200 font-medium mb-2">🎯 Use Cases:</h5>
              <div className="space-y-1">
            ...
            <div>
              <h5 className="text-xs text-sky-200 font-medium mb-2">✨ Benefits:</h5>
              <div className="space-y-1">
