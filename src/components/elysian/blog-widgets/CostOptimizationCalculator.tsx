      ...
      {(volume !== "unknown" || responseType !== "unknown") && (
        <div className="mt-6 rounded-md border border-sky-500/50 bg-sky-900/60 p-4 shadow-sm">
          <div className="mb-3 flex items-center justify-between">
            <h5 className="font-medium text-sky-400">📊 Optimization Strategies:</h5>
            <div className="text-right">
              <div className="text-xs text-sky-300/70">Potential total savings:</div>
              <div className="font-bold text-sky-400">{totalSavingsRange()}</div>
            </div>
          </div>
          <div className="space-y-3">
            {optimizations.map((opt, index) => (
              <div
                key={opt.strategy}
                className="rounded border border-sky-700/30 bg-sky-800/30 p-3"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-xs text-sky-200/80">{opt.description}</p>
                  </div>
                  <div className="ml-3 text-right">
                    <div className="text-sm font-bold text-sky-400">{opt.expectedSavings}</div>
          ...
          <div className="mt-4 rounded border border-sky-600/50 bg-sky-900/40 p-3">
            <h6 className="mb-2 text-sm font-medium text-sky-300">💡 Implementation Tips:</h6>
