...
const ElysianOpsDemo: React.FC = () => {
  return (
    <div className="my-8 border border-gray-200 rounded-lg overflow-hidden shadow-lg">
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-4">
        <h3 className="text-white text-lg font-semibold mb-2">Try ElysianOps Live Demo</h3>
        <p className="text-blue-100 text-sm">
          Experience ElysianOps LLM Observability platform in action - see real agent workflows
      ...
      <div className="p-0">
        <div className="h-[250px] landing-xs:h-[200px] landing-sm:h-[350px] landing-md:h-[500px] landing-lg:h-[600px] landing-xl:h-[700px] relative">
          <iframe
            ...
            title="ElysianOps LLM Observability Platform Demo"
