        ...
        <div className="mt-6">
          <div className="bg-gray-700 rounded-lg p-4">
            <h4 className="text-lg font-semibold text-white mb-3">
              ...
              <span className="text-sky-400 ml-2">{result.recommended} Evaluation</span>
            </h4>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <div className="w-full bg-gray-600 rounded-full h-2">
                  <div
                    className="bg-sky-500 rounded-full h-2 transition-all duration-500"
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <h5 className="font-medium text-sky-300 mb-2 flex items-center">
              ...
              {requirements.map((_, index) => (
                <div
                  ...
                  className={`w-2 h-2 rounded-full ${
                    answers[index] !== -1 ? "bg-sky-500" : "bg-gray-600"
                  }`}
                />
              ))}
            </div>
