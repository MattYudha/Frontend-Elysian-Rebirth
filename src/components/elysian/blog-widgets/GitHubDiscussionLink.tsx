...
export default function GitHubDiscussionLink({
  ...
  return (
    <div style={{ marginBottom: "1rem" }}>
      ...
      <Link
        href={url}
        className="inline-flex items-center no-underline px-4 py-3 sm:py-4 bg-sky-400/10 text-sky-400 border-solid border border-sky-400/20 text-base sm:text-lg font-semibold rounded transition-colors cursor-pointer hover:bg-sky-400/20 w-full justify-center"
        target="_blank"
