  ...
  return (
    <div className="my-6">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-medium transition-colors border border-solid whitespace-nowrap ${
              selectedCategory === category.id
                ...
                : "bg-transparent text-[#0ea5e9] border-[#30363d] hover:bg-[#0ea5e910]"
            }`}
          >
            {category.label}
          </button>
      ...
      <div
        ...
        className="flex items-center cursor-pointer gap-2 text-sm mt-8 text-sky-400 mb-3 transition-colors"
      >
        <svg
          ...
          {filteredEvents.map((event) => (
            <div key={event.id} className="p-4 rounded-md border border-solid border-[#30363d]">
              <div className="flex justify-between items-start mb-1">
                ...
                <span className="text-[10px] px-2 py-0.5 rounded-md bg-sky-400/10 text-sky-400 border border-solid border-sky-400/20 inline-block mb-2">
                  WEBHOOK
                </span>
              </div>
