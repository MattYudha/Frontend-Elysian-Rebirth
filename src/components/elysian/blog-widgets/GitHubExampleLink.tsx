...
const GitHubExampleLink: React.FC<GitHubExampleLinkProps> = ({ repoUrl, npmCommand }) => {
  ...
  return (
    <div className="my-8 px-6 py-4 border-dashed border-sky-500 rounded-lg bg-gray-800">
      <div className="flex-grow">
        <a
          href={repoUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="text-md text-sky-400 hover:text-sky-500 no-underline !hover:no-underline font-medium inline-flex items-center mb-3"
        >
