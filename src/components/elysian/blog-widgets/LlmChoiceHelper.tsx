...
function getRecommendation(role: string, priority: string) {
  if (!role || !priority) {
...
export default function LlmChoiceHelper(): JSX.Element {
  ...
  return (
    ...
    <div className="border-2 border-solid border-sky-500 rounded-lg p-5 mb-6 bg-gray-800 shadow-lg">
      {/* Question 1: Role */}
      <div className="mb-5">
        ...
        <div className="relative cursor-pointer">
          <select
            ...
            className="appearance-none cursor-pointer w-full p-3 bg-gray-800 border border-gray-700 text-white rounded-md 
                      ...
                      hover:border-sky-400/50 transition-all duration-200 text-sm"
          >
        ...
        <div className="relative cursor-pointer">
          <select
            ...
            className={`appearance-none cursor-pointer w-full p-3 bg-gray-800 border rounded-md text-white
                      ...
                      ${
                        selectedRole
                          ? "border-sky-600 hover:border-sky-400 focus:ring-sky-500/70 focus:border-sky-400"
      ...
      {selectedRole && selectedPriority && (
        <div className="mt-6 p-4 bg-sky-900/60 border border-sky-500/50 rounded-md shadow-sm">
          <div className="text-sky-400 font-medium mb-2 text-base">Suggestion:</div>
          <p className="text-sky-100 mb-2">{recommendation}</p>
          <div className="text-sky-300/70 text-xs mt-3">
