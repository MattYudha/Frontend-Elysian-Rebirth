    ...
    <div className="my-6 rounded-lg border-2 border-solid border-sky-500 bg-gray-800 p-5 shadow-lg">
      ...
      {currentIssueDetails && selectedIssue !== "unknown" && (
        <div className="mt-6 rounded-md border border-sky-500/50 bg-sky-900/60 p-4 shadow-sm">
          <h5 className="mb-1 font-semibold text-sky-400">{currentIssueDetails.name}</h5>
          <p className="mb-3 text-sm text-sky-100">{currentIssueDetails.description}</p>
          <h6 className="mb-1 text-sm font-medium text-sky-300">Key Observability Pillars:</h6>
