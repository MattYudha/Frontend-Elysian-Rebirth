    ...
    <div className="border-2 border-solid border-sky-500 rounded-lg p-5 mb-6 bg-gray-800 shadow-lg">
              ...
              className={`flex items-center px-4 py-2 rounded-md transition-all duration-200 cursor-pointer
                ${
                  selectedMode === mode.value
                    ? "bg-sky-700 text-white border-sky-500 border"
        ...
        <div className="relative">
          <input
            ...
            className="w-full p-3 bg-gray-700 border border-gray-600 text-white rounded-md 
                     ...
                     hover:border-sky-400/50 transition-all duration-200"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2 mt-1">
          {sampleQueries[selectedMode as keyof typeof sampleQueries].map((sample, i) => (
            <button
              ...
              className="text-xs px-2 py-1 bg-gray-700 hover:bg-gray-600 rounded-md text-sky-300 cursor-pointer"
            >
              {sample}
            </button>
          ))}
      ...
      {showComparison && (
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          {/* Multimodal RAG */}
          <div className="bg-sky-900/30 p-4 rounded-md border border-sky-500/50">
            <h4 className="text-sky-400 font-medium mb-2">Multimodal RAG Response:</h4>
