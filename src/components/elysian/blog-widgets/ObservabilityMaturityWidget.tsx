...
export default function ObservabilityMaturityWidget(): JSX.Element {
  ...
  return (
    <div className="my-6 p-6 border-2 border-sky-500 bg-gray-900 rounded-lg shadow-lg">
      <div className="mb-6">
              ...
              <div
                ...
                className={`p-4 rounded-lg border-2 cursor-pointer transition-all duration-200 ${
                  selectedLevel === level.level
                    ...
                    : "bg-gray-800 border-gray-600 hover:border-sky-500"
                }`}
              ...
              >
                ...
                {selectedLevel === level.level && (
                  <div className="mt-4 space-y-4">
                    ...
                    <div>
                      <h5 className="font-medium text-sky-300 mb-2">Characteristics:</h5>
                    ...
                    <div>
                      <h5 className="font-medium text-sky-300 mb-2">Typical Tools:</h5>
                      <div className="flex flex-wrap gap-2">
                        {level.tools.map((tool) => (
                          <span
                            key={tool}
                            className="px-2 py-1 bg-gray-700 text-sky-300 rounded text-xs"
                          >
                            {tool}
                          </span>
                        ))}
                    ...
                    <div>
                      <h5 className="font-medium text-sky-300 mb-2">Next Steps:</h5>
                      <ul className="list-disc list-inside text-gray-300 text-sm space-y-1">
      ...
      {showQuiz && !quizResult && (
        <div className="space-y-6">
          <div className="text-center">
            <h4 className="text-lg font-semibold text-sky-400 mb-2">Assessment Quiz</h4>
            <p className="text-gray-300 text-sm">
          ...
          {quizQuestions.map((question, qIdx) => (
            <div key={question.question} className="bg-gray-800 p-4 rounded-lg">
              <h5 className="font-medium text-sky-300 mb-3">
      ...
      {quizResult && (
        <div className="text-center space-y-4">
          <div className={`p-6 rounded-lg border-2 ${getLevelColor(quizResult)}`}>
            ...
            <h5 className="text-lg font-semibold text-sky-300 mb-3">
              {maturityLevels[quizResult - 1].title}
            </h5>
            <p className="text-gray-300 mb-4">{maturityLevels[quizResult - 1].description}</p>

            <div className="text-left">
              <h6 className="font-medium text-sky-300 mb-2">Recommended Next Steps:</h6>
              <ul className="list-disc list-inside text-gray-300 text-sm space-y-1">
      ...
      <div className="mt-6 text-xs text-gray-400 border-t border-gray-700 pt-4">
        <strong className="text-sky-400">Tip:</strong> Most teams start at Level 1-2. The key is
