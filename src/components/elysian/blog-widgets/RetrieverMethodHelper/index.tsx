...
const RetrieverMethodHelper: React.FC = () => {
  ...
  return (
    <div className="border border-solid border-sky-500 rounded-lg p-5 mb-6 bg-gray-800 shadow-lg">
      <h4 className="mt-0 mb-6 text-lg font-semibold text-sky-400 text-center">
          ...
          {frequencyOptions.map((option) => (
            <label
              ...
              className={clsx(
                ...
                "hover:border-sky-400/50 hover:bg-gray-700", // Hover state
                frequency === option.value
                  ? "border-sky-500 bg-sky-900/30" // Checked state
        ...
        <div
          ...
          className={clsx(
            ...
            recommendation.method === "Unsure"
              ...
              : "bg-sky-900/60 border-sky-500/50", // Emerald theme for others
          )}
        >
          <h5
            className={clsx(
              ...
              recommendation.method === "Unsure"
                ...
                : "text-sky-400", // Emerald title for others
            )}
          >
          ...
          <p
            className={clsx(
              ...
              recommendation.method === "Unsure"
                ...
                : "text-sky-100", // Lighter emerald text for others
            )}
          >
          ...
          {recommendation.method !== "Unsure" && (
            <p className="text-sm text-sky-100">
              ...
              <a
                ...
                className="text-sky-400 hover:underline" // Link styling
              >
