        ...
        {models.map((model) => (
          ...
          >
            <div className="flex items-center justify-between">
              <h4 className="font-medium text-sky-400">{model.name}</h4>
      ...
      {selectedModel && (
        <div className="border border-sky-500/50 rounded-lg p-5 bg-gray-800/80 animate-fadeIn">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-lg font-semibold text-sky-400">{selectedModel.name}</h3>
          ...
          <div className="mb-4">
            <h4 className="text-sm font-medium text-sky-300 mb-2">Strengths:</h4>
