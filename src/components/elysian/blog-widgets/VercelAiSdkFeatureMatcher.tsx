    ...
    <div className="my-6 rounded-lg border-2 border-solid border-sky-500 bg-gray-800 p-5 shadow-lg">
      ...
      {interactionType !== "unknown" && (
        <div className="mt-6 rounded-md border border-sky-500/50 bg-sky-900/60 p-4 shadow-sm">
          <h5 className="mb-2 font-medium text-sky-400">Recommended Vercel AI SDK Feature:</h5>
          <p className="text-md font-semibold text-sky-100">{currentRecommendation.feature}</p>
          <p className="mt-1 text-sm text-sky-200">{currentRecommendation.description}</p>
