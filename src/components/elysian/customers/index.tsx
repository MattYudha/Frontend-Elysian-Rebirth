        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 landing-sm:gap-12 mb-12 sm:mb-24">
          ...
          <div className="flex flex-col justify-center">
            <div className="flex items-baseline justify-start mb-6">
              ...
              <span className="text-3xl sm:text-4xl font-bold text-[#00d992]">elysian</span>
            ...
            <p className="text-base text-gray-400 mb-8 leading-relaxed">
              <span className="text-[#00d992] font-semibold">Elysian</span> is the TypeScript AI
              agent framework, while <span className="text-orange-400 font-semibold">ElysianOps</span>{" "}
