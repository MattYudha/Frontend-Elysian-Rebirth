  ...
  return (
    <div className="step-section mb-12 ">
      <div className="flex flex-col xl:flex-row  lg:gap-10">
        ...
        >
          <div className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-semibold text-sm bg-sky-500/10 text-sky-400 border border-solid border-sky-500/30">
            {stepNumber}
          </div>
