      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base text-gray-400 mb-4 leading-relaxed max-w-3xl">
              ...
              <span className="text-[#00d992] font-semibold">Elysian</span>.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <a
            ...
            className="group relative border-solid bg-gradient-to-br from-sky-500/20 via-slate-900/70 to-slate-900/30 border-sky-500/20 border rounded-xl overflow-hidden transition-all duration-300 hover:border-sky-500/40 hover:shadow-2xl hover:shadow-sky-600/20 cursor-pointer no-underline shadow-2xl shadow-sky-600/20"
          >
            {/* Glow effects */}
            <div className="absolute -top-12 -right-8 h-32 w-32 rounded-full bg-sky-500/30 blur-3xl pointer-events-none" />
            <div className="absolute -bottom-6 -left-5 h-24 w-24 rounded-full bg-sky-400/20 blur-[100px] pointer-events-none" />
