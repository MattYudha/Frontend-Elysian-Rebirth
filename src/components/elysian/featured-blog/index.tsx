    ...
    <section className="relative w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 landing-xs:mb-12 md:mb-24 landing-md:mb-36">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
          {REAL_POSTS.map((post) => (
            ...
            >
              ...
              <h3 className="landing-xs:text-sm md:text-base landing-lg:text-lg font-semibold leading-tight mb-3 sm:mb-4 text-sky-400 overflow-hidden">
        ...
        <div className="mt-4 sm:mt-6 md:mt-8 flex justify-center">
          ...
          >
            <span className="text-sm sm:text-base text-sky-400 font-medium mr-2">
              Read all posts
            </span>
            <ChevronRightIcon className="h-3 w-3 sm:h-4 sm:w-4 text-sky-400 group-hover:translate-x-1 transition-transform" />
          </a>
        </div>
      </div>
    </section>
