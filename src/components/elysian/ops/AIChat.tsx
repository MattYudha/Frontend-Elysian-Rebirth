          ...
          <div className="flex-1 px-0">
            <div className="flex flex-wrap py-2 gap-5">
              ...
              <div className="relative">
                <span className="absolute -top-3 left-2 px-1  bg-sky-400/5 rounded-sm text-sky-400 border border-solid border-sky-400/20 text-[10px] capitalize">
                  Model
                </span>
          ...
          {messages.length === 0 ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <ChatBubbleLeftIcon className="w-6 h-6 sm:w-8 sm:h-8 text-sky-400 mx-auto mb-2" />
            ...
            <div className="space-y-3">
              ...
              {isTyping && (
                <div className="flex justify-start">
                  <div className="max-w-[80%] p-2 sm:p-3 rounded-lg bg-sky-600/30 text-[#e2e8f0]">
          ...
          <div className="px-2 sm:px-3 py-1 border-t border-[#1e293b]/70">
            <div className="flex flex-wrap gap-2 sm:gap-3 justify-center overflow-x-auto [&::-webkit-scrollbar]:hidden">
              <button
                ...
                className="px-2 sm:px-3 py-1 rounded-full text-[#00d992] border-sky-400 border-solid text-xs cursor-pointer transition-all duration-200 whitespace-nowrap border border-gray-800 bg-transparent"
              >
