...
const initialDeploymentStages: DeploymentStage[] = [
  ...
  {
    id: 4,
    name: "Deploying to Elysian's global network",
    status: "pending",
    duration: "8s",
  },
];

// Mock deployment log data reflecting a generic Node.js/Elysian build
const initialDeploymentLogs: DeploymentLog[] = [
  ...
  {
    id: 10,
    message: "> elysian-app@1.0.0 build",
  ...
  {
    id: 13,
    message: "[Elysian] Validating agent schemas...",
    timestamp: "10:30:36.100",
    stageId: 3,
    visible: false,
    type: "default", // Could be a custom Elysian type if needed
  },
  {
    id: 14,
  ...
  {
    id: 15,
    message: "[Elysian] Starting deployment process...",
  ...
  {
    id: 18,
    message: "[Elysian] Deployed! 'my-agent-v1.2' is live.",
...
const timeline: TimelineEvent[] = [
  ...
  { time: 8900, action: "showLog", logIndex: 9 }, // > elysian-app...
  { time: 9000, action: "showLog", logIndex: 10 }, // > tsc...
  { time: 11000, action: "showLog", logIndex: 11 }, // Compiling TS...
  { time: 11500, action: "showLog", logIndex: 12 }, // [Elysian] Validating...
  ...
  { time: 13000, action: "showLog", logIndex: 14 }, // [Elysian] Starting...
  { time: 14000, action: "showLog", logIndex: 15 }, // Uploading...
  { time: 18000, action: "showLog", logIndex: 16 }, // Upload complete...
  { time: 20700, action: "showLog", logIndex: 17 }, // [Elysian] Deployment successful!
...
const DeploymentLogItem = ({ log }: { log: DeploymentLog }) => {
  ...
  const messageColor =
    log.type === "build"
      ? "text-red-500"
      : log.type === "deploy"
        ? "text-sky-400" // Use emerald for deploy success
        : "text-gray-400";
