...
import { LangfuseLogo } from "@/components/elysian/logos/observability/langfuse";
import { LangWatchLogo } from "@/components/elysian/logos/observability/langwatch";
import { BraintrustLogo2 } from "@/components/elysian/logos/observability/braintrust-2";
import { Dash0Logo } from "@/components/elysian/logos/observability/dash0";
import HoneyhiveLogo from "@/components/elysian/logos/observability/honeyhive.png";
import { LangSmithLogo } from "@/components/elysian/logos/observability/langsmith";
import { NewRelicLogo } from "@/components/elysian/logos/observability/new-relic";
import { SignozLogo } from "@/components/elysian/logos/observability/signoz";
import TraceLogo from "@/components/elysian/logos/observability/traceloop.png";
...
const codeExamples = {
  langfuse: (
    <>
      ...
      <span className="text-gray-300">{"{ Elysian }"}</span>{" "}
      <span className="text-blue-400">from</span>{" "}
      <span className="text-sky-400">"@elysian/core"</span>
      <br />
      <span className="text-blue-400">import</span>{" "}
      <span className="text-gray-300">{"{ LangfuseExporter }"}</span>{" "}
      <span className="text-blue-400">from</span>{" "}
      <span className="text-sky-400">"langfuse-vercel"</span>
      <br />
      <br />
      <span className="text-purple-400">export const</span>{" "}
      <span className="text-gray-300">elysian</span> <span className="text-gray-500">=</span>{" "}
      ...
      <span className="text-sky-400">"custom"</span>
      <span className="text-gray-300">,</span>
      <br />
      {"      "}
  ...
  langsmith: (
    <>
      ...
      <span className="text-blue-400">from</span>{" "}
      <span className="text-sky-400">"prometheus-exporter"</span>
      <br />
      <br />
      <span className="text-purple-400">export const</span>{" "}
      <span className="text-gray-300">elysian</span> <span className="text-gray-500">=</span>{" "}
  ...
  braintrust: (
    <>
      ...
      <span className="text-sky-400">"@sentry/node"</span>
      <br />
      <br />
  ...
  dash0: (
    <>
      ...
      <span className="text-blue-400">from</span>{" "}
      <span className="text-sky-400">"datadog-agent"</span>
      <br />
      <br />
      <span className="text-purple-400">export const</span>{" "}
      <span className="text-gray-300">elysian</span> <span className="text-gray-500">=</span>{" "}
  ...
  langwatch: (
    <>
      ...
      <span className="text-blue-400">from</span>{" "}
      <span className="text-sky-400">"opentelemetry-js"</span>
      <br />
      <br />
      <span className="text-purple-400">export const</span>{" "}
      <span className="text-gray-300">elysian</span> <span className="text-gray-500">=</span>{" "}
      ...
      {"      "}
      <span className="text-gray-300">type: </span>
      <span className="text-sky-400">"opentelemetry"</span>
      <span className="text-gray-300">,</span>
      <br />
      {"      "}
      <span className="text-gray-300">exporter: </span>
    ...
    >
      <div className="relative group">
        <div className="flex flex-col items-center">
          ...
          {isActive && (
            <div className="absolute -top-1 -right-1 w-2 h-2 bg-[#38bdf8] animate-pulse rounded-full shadow-[0_0_8px_rgba(56,189,248,0.6)]" />
          )}
          {/* 
...
const CodeBlock = ({ code, isActive }: { code: React.ReactNode; isActive: boolean }) => {
  ...
  return (
    <div className="mt-2 sm:mt-3">
      <div className="relative max-w-4xl overflow-hidden border border-[#1e2730] hover:border-[#38bdf8] transition-all duration-300 rounded-lg">
        {/* Sky-blue glowing bar at top */}
        <motion.div
          className="absolute top-0 left-0 w-full h-[3px] rounded-t-lg landing-xs:hidden landing-md:block"
          style={{
            background:
              "linear-gradient(45deg, rgb(56, 189, 248), rgb(56, 189, 248), rgb(56, 189, 248), rgb(56, 189, 248)) 0% 0% / 300%",
          }}
          animate={{
        ...
        <pre className="text-left bg-white/5 overflow-x-auto rounded-lg p-0 text-[10px] sm:text-sm font-mono m-0 h-[250px] sm:h-[347px]">
          <div className="flex">
            ...
            <div className="py-7 px-3 block landing-xs:text-[9px] landing-md:text-xs w-full relative">
              <motion.div
                className="absolute inset-0 bg-[#38bdf8]/5 rounded-r"
                layoutId="observabilityCodeHighlight"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
