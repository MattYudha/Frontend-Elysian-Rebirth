      ...
      <div className="max-w-7xl mx-auto px-4 landing-xs:mb-16 landing-md:mb-36">
          ...
          <div className="w-full max-w-5xl">
            <div className="mb-4">
              ...
              <p className="max-w-3xl landing-md:text-xl landing-xs:text-md text-gray-400">
                From tracking deployments to debugging and live interaction, Elysian gives you
        ...
        <div className="grid grid-cols-1 landing-md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-6">
            {/* Deployment Card */}
            <div className="rounded-lg border border-solid border-white/10 hover:border-sky-400  transition-all duration-300 overflow-hidden h-auto">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 landing-lg:text-sm landing-xs:text-xs mb-0 leading-relaxed">
                      {getResponsiveText(
                        ...
                        "Deploy your Agents in seconds with Elysian Deployment.",
                      )}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 landing-lg:text-sm landing-xs:text-xs mb-0 leading-relaxed">
                      {getResponsiveText(
                        ...
                        "Debug and analyze your Elysian-powered AI agent's behavior with visual flows.",
                      )}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 landing-lg:text-sm landing-xs:text-xs mb-0 leading-relaxed">
                      {getResponsiveText(
                        ...
                        "Connect your Elysian-powered AI agents to popular observability platforms.",
                      )}
                    </p>
                  </div>
                </div>
