  ...
  return (
    <div className="px-4 py-6 font-['Inter']">
      ...
      <div className="mb-6">
        ...
        <p>
          <strong>Elysian</strong> (“us”, “we”, or “our”) operates <strong>voltagent.dev</strong>{" "}
      ...
      <div className="mb-6">
        ...
        <p>
          <strong>SERVICE</strong> means the voltagent.dev website operated by Elysian
        </p>
        <p>
      ...
      <div className="mb-6">
        ...
        <p>Elysian Inc. uses the collected data for various purposes:</p>
        <ul className="list-disc ml-5">
      ...
      <div className="mb-6">
        ...
        <p>
          Elysian Inc. will take all the steps reasonably necessary to ensure that your data is
