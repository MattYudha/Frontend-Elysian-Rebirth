...
import {
  ...
  PostgresLogo,
  VoyageLogo,
} from "@/components/elysian/logos/integrations";
import { OpenAILogo } from "@/components/elysian/logos/openai";
import { SupabaseLogo } from "@/components/elysian/logos/supabase";

export function RagExample({ isVisible }: { isVisible?: boolean }) {
  ...
  // Animation steps for Elysian RAG
  const totalSteps = 6;
      ...
      if (currentStep < totalSteps) {
        setTimeout(() => {
          ...
          if (currentStep + 1 === 1) {
            ...
            typeText("User input: 'What are the latest features of Elysian?'");
        ...
        <div className="w-full  mb-16   transition-all duration-500">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full relative  px-4 py-12" ref={diagramRef}>
              ...
              <div className="border border-slate-200 dark:border-[#3d3a39] rounded-lg  mx-auto max-w-6xl">
                {/* Section Headers */}
                <div className="grid grid-cols-5 mb-12">
                  <div className="col-span-1" />
                  <div className="col-span-1 flex justify-center">
                    <div className="text-slate-900 dark:text-white text-md font-[monospace]">.embed()</div>
                  </div>
                  <div className="col-span-1 flex justify-center">
                    <div className="text-slate-900 dark:text-white text-md font-[monospace]">.query()</div>
                  </div>
                  <div className="col-span-1 flex justify-center">
                    <div className="text-slate-900 dark:text-white text-md font-[monospace]">.rerank()</div>
                  </div>
                  <div className="col-span-1" />
                </div>
                ...
                <div className="grid grid-cols-5 gap-8 mb-4">
                  ...
                  <div className="flex justify-end items-center">
                    <div
                      ref={inputNodeRef}
                      className={`w-[150px] h-[50px] px-4 rounded-md border border-slate-200 dark:border-[#3d3a39] text-sm flex items-center bg-white dark:bg-[#101010] gap-3 transition-all duration-700 ease-out opacity-100 scale-100 ${getNodeHighlightClass(
                        "input",
                      )}`}
                    >
                      <div className="bg-slate-100 dark:bg-[#1a1a1a] w-7 h-7 rounded flex items-center justify-center">
                        <UserIcon className="w-4 h-4 text-[#8a8380]" />
                      </div>
                      <span className="font-medium text-slate-900 dark:text-white text-xs">input</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <span className="font-medium text-xs text-slate-900 dark:text-white leading-tight">model</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    >
                      ...
                      <span className=" font-medium text-slate-900 dark:text-white text-xs">retrieval</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    >
                      ...
                      <span className=" font-medium text-slate-900 dark:text-white text-xs">llm</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-start items-center">
                    ...
                    >
                      ...
                      <span className=" font-medium text-slate-900 dark:text-white text-xs">output</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex justify-end items-center">
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <span className="font-medium text-xs text-slate-900 dark:text-white leading-tight">base</span>
                      </div>
                    </div>
                  </div>
