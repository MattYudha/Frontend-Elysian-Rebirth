...
export function RagMobile({ isVisible }: { isVisible?: boolean }) {
            ...
            <div className=" py-8 mx-auto max-w-md">
              ...
              <div className="flex flex-col gap-12">
                ...
                <div className="flex justify-between gap-5">
                  <div
                    ref={inputNodeRef}
                    className={`w-[120px] px-2 py-2 rounded-md bg-white dark:bg-gray-950 border border-slate-200 dark:border-gray-800 flex flex-col items-center text-center ${getNodeHighlightClass(
                      "input",
                    )}`}
                  >
                    <span className="font-medium text-slate-900 dark:text-white text-[10px]">Input</span>
                  </div>
                  <div
                  ...
                  >
                    <span className="font-medium text-[10px] text-slate-900 dark:text-white">Knowledge base</span>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    >
                      <div className="flex flex-col justify-center">
                        <span className="font-medium text-[10px] text-slate-900 dark:text-white leading-tight">
                          Embedding model
                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="text-slate-900 dark:text-white text-md font-[monospace] self-center">.embed()</div>
                  <div className="flex flex-col items-center">
                    <div
                ...
                <div className="flex justify-between ">
                  ...
                  <div className="text-slate-900 dark:text-white text-md font-[monospace] self-center">.query()</div>
                  <div className="flex flex-col items-center">
                    <div
                    ...
                    >
                      <span className="font-medium text-slate-900 dark:text-white text-[10px]">Vector stores</span>
                    </div>
                ...
                <div className="flex justify-between gap-4">
                  <div className="flex flex-col items-center">
                    <div
                      ref={llmNodeRef}
                      className={`w-[120px] px-2 py-2 rounded-md border-solid bg-white dark:bg-gray-950 border border-slate-200 dark:border-gray-800 flex flex-col items-center text-center ${getNodeHighlightClass(
                        "llm",
                      )}`}
                    >
                      <span className="font-medium text-slate-900 dark:text-white text-[10px]">LLM</span>
                    </div>
                    <div className="mt-2">{renderLLMLogos()}</div>
                  </div>
                  <div className="text-slate-900 dark:text-white text-md font-[monospace] self-center">.rerank()</div>
                ...
                <div className="flex gap-4">
                  <div className="flex flex-col items-center ml-0">
                    ...
                    >
                      <span className="font-medium text-slate-900 dark:text-white text-[10px]">Output</span>
                    </div>
                  </div>
                  <div className="w-[120px]" />
                </div>
