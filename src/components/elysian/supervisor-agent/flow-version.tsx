...
// Custom node styles
const nodeStyles = {
  user: "border-solid border-[#38bdf8] text-slate-900 dark:text-[#ffff] bg-white dark:bg-[#0A0F15] px-2 py-1 text-xs rounded min-w-[80px] flex flex-col items-center justify-center shadow-[0_0_15px_rgba(52,211,153,0.1)] dark:shadow-[0_0_15px_rgba(52,211,153,0.3)]",
  supervisor:
    "border-solid border-[#818cf8] text-slate-900 dark:text-[#ffff] bg-white dark:bg-[#0A0F15] px-2 py-1 text-xs rounded min-w-[80px] flex flex-col items-center justify-center shadow-[0_0_15px_rgba(129,140,248,0.1)] dark:shadow-[0_0_15px_rgba(129,140,248,0.3)]",
  agentA:
    "border-solid border-[#60a5fa] text-slate-900 dark:text-[#ffff] bg-white dark:bg-[#0A0F15] px-2 py-1 text-xs rounded min-w-[80px] flex flex-col items-center justify-center shadow-[0_0_15px_rgba(96,165,250,0.1)] dark:shadow-[0_0_15px_rgba(96,165,250,0.3)]",
  agentB:
    "border-solid border-[#2dd4bf] text-slate-900 dark:text-[#ffff] bg-white dark:bg-[#0A0F15] px-2 py-1 text-xs rounded min-w-[80px] flex flex-col items-center justify-center shadow-[0_0_15px_rgba(45,212,191,0.1)] dark:shadow-[0_0_15px_rgba(45,212,191,0.3)]",
  agentC:
    "border-solid border-[#a855f7] text-slate-900 dark:text-[#ffff] bg-white dark:bg-[#0A0F15] px-2 py-1 text-xs rounded min-w-[80px] flex flex-col items-center justify-center shadow-[0_0_15px_rgba(168,85,247,0.1)] dark:shadow-[0_0_15px_rgba(168,85,247,0.3)]",
  memory:
    "border-solid border-slate-200 dark:border-[#4b5563] text-slate-900 dark:text-[#ffff] bg-white dark:bg-[#0A0F15] px-2 py-1 text-xs rounded min-w-[100px] flex flex-col items-center justify-center gap-1 shadow-[0_0_15px_rgba(75,85,99,0.1)] dark:shadow-[0_0_15px_rgba(75,85,99,0.3)]",
  groupLabel: "text-[#38bdf8] absolute -top-6 left-0 text-xs",
  thinkinglabel: "text-[#38bdf8] absolute -top-6 left-0 text-xs",
  teamlabel: "text-[#38bdf8] absolute -top-8 left-0 text-xs",
  historyLabel: "text-[#38bdf8] absolute top-[180px] left-[350px] text-xs",
};
  ...
  data: {
    label: (
      <div className="relative">
          <span
            className="absolute -top-5 left-1/2 -translate-x-1/2 text-[10px] opacity-0 transition-opacity duration-300 text-slate-900 dark:text-white"
            data-status
          >
          executing...
        </span>
...
const initialNodes: Node[] = [
  ...
  createAgentNode("agent-b", { x: 500, y: 75 }, "Compliance Agent", "gpt-4", nodeStyles.agentB),
  createAgentNode("agent-c", { x: 500, y: 150 }, "Committer Agent", "Custom LLM", nodeStyles.agentC),
  {
    id: "team-line",
...
export const FlowVersion = ({ isVisible }: FlowVersionProps) => {
  ...
  const startAnimation = useCallback(() => {
    ...
    const steps = [
      ...
      () => {
        setEdges([
          createEdge("user", "supervisor-group", "#38bdf8", true),
          createMemoryEdge("supervisor-group", "user-lead-memory"),
          createMemoryEdge("team-line", "lead-team-memory"),
        ]);
  ...
  return (
    <div className="w-full h-[425px] bg-slate-100/50 dark:bg-[#3A42594D] backdrop-blur-md">
      <ReactFlow
        nodes={nodes}
        edges={edges}
