...
import { OpenAILogo } from "@/components/elysian/logos/openai";
...
export function WorkflowCodeExample({ isVisible, isDark: isDarkProp }: WorkflowCodeExampleProps) {
  ...
  const agentColors = {
    A: {
      border: isDark ? "border-blue-400/70" : "border-blue-300",
      text: isDark ? "text-blue-300" : "text-blue-600",
      shadow: isDark ? "shadow-[0_0_15px_rgba(96,165,250,0.3)]" : "shadow-[0_0_15px_rgba(59,130,246,0.1)]",
      activeShadow: isDark ? "shadow-[0_0_20px_rgba(96,165,250,0.5)]" : "shadow-[0_0_20px_rgba(59,130,246,0.3)]",
      bg: isDark ? "bg-blue-500/10" : "bg-blue-500/5",
      beam: isDark ? "#60a5fa" : "#3b82f6",
      beamOpacity: isDark ? "rgba(96, 165, 250, 0.4)" : "rgba(59, 130, 246, 0.2)",
    },
    B: {
      border: isDark ? "border-teal-400/70" : "border-teal-300",
      text: isDark ? "text-teal-300" : "text-teal-600",
      shadow: isDark ? "shadow-[0_0_15px_rgba(45,212,191,0.3)]" : "shadow-[0_0_15px_rgba(13,148,136,0.1)]",
      activeShadow: isDark ? "shadow-[0_0_20px_rgba(45,212,191,0.5)]" : "shadow-[0_0_20px_rgba(13,148,136,0.3)]",
      bg: isDark ? "bg-teal-500/10" : "bg-teal-500/5",
      beam: isDark ? "#2dd4bf" : "#0d9488",
      beamOpacity: isDark ? "rgba(45, 212, 191, 0.4)" : "rgba(13, 148, 136, 0.2)",
    },
    C: {
      border: isDark ? "border-purple-400/70" : "border-purple-300",
      text: isDark ? "text-purple-300" : "text-purple-600",
      shadow: isDark ? "shadow-[0_0_15px_rgba(168,85,247,0.3)]" : "shadow-[0_0_15px_rgba(124,58,237,0.1)]",
      activeShadow: isDark ? "shadow-[0_0_20px_rgba(168,85,247,0.5)]" : "shadow-[0_0_20px_rgba(124,58,237,0.3)]",
      bg: isDark ? "bg-purple-500/10" : "bg-purple-500/5",
      beam: isDark ? "#a855f7" : "#7c3aed",
      beamOpacity: isDark ? "rgba(168, 85, 247, 0.4)" : "rgba(124, 58, 237, 0.2)",
    },
    User: {
      border: isDark ? "border-sky-400/70" : "border-sky-300",
      text: isDark ? "text-sky-300" : "text-sky-600",
      shadow: isDark ? "shadow-[0_0_15px_rgba(52,211,153,0.3)]" : "shadow-[0_0_15px_rgba(2,132,199,0.1)]",
      activeShadow: isDark ? "shadow-[0_0_20px_rgba(52,211,153,0.5)]" : "shadow-[0_0_20px_rgba(2,132,199,0.3)]",
      bg: isDark ? "bg-sky-500/10" : "bg-sky-500/5",
      beam: isDark ? "#38bdf8" : "#0284c7",
      beamOpacity: isDark ? "rgba(56, 189, 248, 0.4)" : "rgba(2, 132, 199, 0.2)",
    },
    Supervisor: {
      border: isDark ? "border-indigo-400/70" : "border-indigo-300",
      text: isDark ? "text-indigo-300" : "text-indigo-600",
      shadow: isDark ? "shadow-[0_0_15px_rgba(129,140,248,0.3)]" : "shadow-[0_0_15px_rgba(79,70,229,0.1)]",
      activeShadow: isDark ? "shadow-[0_0_20px_rgba(129,140,248,0.5)]" : "shadow-[0_0_20px_rgba(79,70,229,0.3)]",
      bg: isDark ? "bg-indigo-500/10" : "bg-indigo-500/5",
      beam: isDark ? "#818cf8" : "#4f46e5",
      beamOpacity: isDark ? "rgba(129, 140, 248, 0.4)" : "rgba(79, 70, 229, 0.2)",
    },
  };
  ...
  return (
    <>
      <div className="relative w-full" ref={containerRef}>
        <div className="w-full border border-slate-200 dark:border-[#3d3a39] rounded-lg transition-all duration-500 ">
          <div className="flex flex-col items-center">
            {/* Diagram Section - Top Side */}
            <div className="w-full relative min-h-[650px]  py-12" ref={diagramRef}>
              {/* Mobile Memory Sidebar */}
              {isMobile && (
                <div className="absolute left-0 top-0 w-[25%] h-full border-r border-slate-200 dark:border-[#3d3a39] px-2">
                  <div className="sticky top-0 flex flex-col gap-4">
                    <div className="text-xs text-sky-400 font-mono">Memory</div>
                    <div
                      ref={userLeadMemoryRef}
                      className="px-2 py-1 rounded-md text-[10px] bg-white dark:bg-[#101010]/50 border border-slate-200 dark:border-[#3d3a39]"
                    >
              ...
              <div className={`${isMobile ? "pl-[28%]" : ""}`}>
                ...
                >
                  ...
                  <div className="flex items-center justify-center relative w-full lg:w-[350px] md:w-[300px]">
                    <div
                      ref={userNodeRef}
                      className={`px-4 py-2 rounded-md bg-white dark:bg-[#101010] text-sm flex items-center gap-3 transition-all duration-700 ease-out ${
                        isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"
                      } ${
                        animationStep >= 1
                          ? `${agentColors.User.border} ${agentColors.User.shadow}`
                          : "border border-slate-200 dark:border-[#3d3a39]"
                      }`}
                    >
                      <UserIcon className={`w-5 h-5 ${agentColors.User.text}`} />
                      <div className="flex flex-col items-start">
                        <div className="text-slate-900 dark:text-white">User</div>
                  ...
                  <div className="flex items-center justify-center">
                    <div
                      ...
                      className={`relative px-4 md:px-8 lg:px-12 py-12 md:py-16 lg:py-12 rounded-lg border border-dashed border-slate-200 dark:border-[#3d3a39] transition-all duration-700 ease-out ${
                        isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"
                      }`}
                    >
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-white dark:bg-[#020202] px-2 text-xs text-sky-400 font-mono">
                        Lead Agent
                      </div>
                      <div className="relative w-full lg:w-[170px] md:w-[150px] justify-center items-center">
                        <div
                          ref={supervisorNodeRef}
                          className={`px-4 py-2 rounded-md bg-white dark:bg-[#101010] ${
                        ...
                        >
                          {supervisorProcessing && (
                            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-full text-center">
                              <div
                                className={`inline-block text-xs font-mono ${agentColors.Supervisor.text} ${agentColors.Supervisor.border} px-2 py-1 rounded-md bg-white/80 dark:bg-[#101010]/50 animate-agent-pulse`}
                              >
                                Thinking...
                              </div>
                            </div>
                          ...
                          <div className="flex flex-col">
                             <span className="text-slate-900 dark:text-white">Supervisor</span>
                  ...
                  >
                    <div
                      ref={teamRegionRef}
                      className={`relative px-12 py-12 rounded-lg border border-dashed border-slate-200 dark:border-[#3d3a39] transition-all duration-700 ease-out ${
                        isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"
                      }`}
                    >
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-white dark:bg-[#020202] px-2 text-xs text-sky-400 font-mono">
                      ...
                      >
                        ...
                        <div className="relative">
                          {currentThinkingAgent === "A" && (
                            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-full text-center">
                              <div
                                  ...
                                  } px-2 py-1 rounded-md bg-white/80 dark:bg-[#101010]/50 ${
                          ...
                          <div
                            ref={agentANodeRef}
                            className={`px-4 py-2 rounded-md w-[170px] bg-white dark:bg-[#101010] ${
                              agentColors.A.border
                            } text-sm flex items-center gap-2 transition-all duration-700 ease-out ${
                              isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"
                            } ${
                          ...
                          >
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center">
                                <span className="text-slate-900 dark:text-white font-semibold">Auditor Agent</span>
                              </div>
                              <div className="flex items-center gap-1 mt-0.5">
                        ...
                        <div className="relative">
                          ...
                          <div
                            ref={agentBNodeRef}
                            className={`px-4 py-2 w-[170px] rounded-md bg-white dark:bg-[#101010] ${
                              agentColors.B.border
                            } text-sm flex items-center gap-2 transition-all duration-700 ease-out ${
                              isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"
                            } ${
                          ...
                          >
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center">
                                <span className="text-slate-900 dark:text-white font-semibold">Compliance</span>
                              </div>
                              <div className="flex items-center gap-1 mt-0.5">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center">
                                <span className="text-white font-semibold">Committer</span>
                              </div>
                              <div className="flex items-center gap-1 mt-0.5">
              ...
              <div className="mt-8 relative">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 md:gap-6 lg:gap-8">
                  ...
                  <div className="lg:col-span-2 md:col-span-1 flex justify-center mt-10 h-[85px] relative">
                    <div className="absolute -top-3 transform bg-white dark:bg-[#020202] px-2 text-xs text-sky-400 font-mono">
                      Conversation-History
                    </div>
                    <div className="relative px-2 xl:px-8 py-6 rounded-lg w-full lg:w-[85%] border border-dashed border-slate-200 dark:border-[#3d3a39] transition-all duration-700 ease-out">
                      <div className="flex flex-col md:flex-row justify-between gap-4 md:gap-10 lg:gap-20">
                        {/* User-Lead Memory */}
                        <div
                          ref={userLeadMemoryRef}
                          className={`px-2 md:px-4 py-2 rounded-md bg-white dark:bg-[#101010] text-xs md:text-sm flex items-center gap-2 transition-all duration-700 ease-out border border-slate-200 dark:border-transparent ${
                            isVisible
                              ? "opacity-100 scale-100 shadow-[0_0_15px_rgba(92,88,85,0.1)] dark:shadow-[0_0_15px_rgba(92,88,85,0.3)]"
                              : "opacity-0 scale-90"
                          }`}
                        >
                        ...
                        <div
                          ref={leadTeamMemoryRef}
                          className={`px-2 lg:px-4 py-2 rounded-md bg-white dark:bg-[#101010] text-sm flex items-center gap-2 transition-all duration-700 ease-out border border-slate-200 dark:border-transparent ${
                            isVisible
                              ? "opacity-100 scale-100 shadow-[0_0_15px_rgba(92,88,85,0.1)] dark:shadow-[0_0_15px_rgba(92,88,85,0.3)]"
                              : "opacity-0 scale-90"
                          }`}
