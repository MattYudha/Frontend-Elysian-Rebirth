...
export function DiscordMessage({
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="relative flex size-full max-w-lg flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md border-slate-200 dark:border-white/10 border-solid bg-white dark:bg-slate-900/50 h-[170px]">
