...
export function LinkedInPost({ profileImage, name, title, content, url }: LinkedInPostProps) {
  ...
  const PostContent = () => (
    <div className="relative flex size-full max-w-lg flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md border-slate-200 dark:border-white/10 border-solid bg-white dark:bg-slate-900/50 hover:border-sky-500 transition-colors duration-200 h-[210px]">
      ...
      <div className="break-words text-slate-600 dark:text-[#dcdcdc] leading-normal tracking-tighter flex-1 overflow-hidden">
