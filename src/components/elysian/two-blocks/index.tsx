  ...
  return (
    <div className="text-white relative w-full overflow-hidden landing-xs:mb-16 landing-md:mb-36">
      <div className="max-w-7xl mx-auto landing-xs:px-3 landing-md:px-4">
        {/* Header Section */}
        {/*  <div className="mb-12">
          <h2 className="landing-xs:text-sm landing-md:text-lg landing-xs:mb-2 landing-md:mb-4 font-semibold text-sky-400 tracking-wide uppercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 landing-xs:gap-6 landing-md:gap-8 items-stretch">
          ...
          <div>
            <div className="flex flex-col items-center gap-2 landing-xs:mb-3 landing-md:mb-4">
              <p className="text-sky-400 landing-xs:text-lg landing-md:text-xl font-bold mb-0 uppercase tracking-wide text-center">
                DEVELOPMENT & ORCHESTRATION{" "}
              </p>
              <span className="text-gray-300 landing-xs:text-base landing-md:text-lg text-center">
                Build agents with Elysian
              </span>
            </div>
            ...
            <div className="relative landing-xs:p-4 landing-md:p-6 rounded-lg border border-solid border-white/10  hover:border-[#00d992]/30 transition-all duration-300 ">
              <div className="landing-xs:mb-3 landing-md:mb-4">
                <div className="flex items-center gap-2 landing-xs:mb-1 landing-md:mb-2">
                  <p className="landing-xs:text-lg landing-md:text-2xl mb-0 font-bold text-white ">
                    Elysian{" "}
                    <span className="landing-xs:text-lg landing-md:text-2xl font-bold text-sky-400">
                      Framework
                    </span>
                  </p>
              ...
              <a
                ...
                className="w-full landing-xs:py-2 landing-xs:px-3 landing-md:py-3 landing-md:px-4 text-sky-400 font-semibold rounded-lg border border-sky-400/20 bg-sky-400/10 hover:bg-sky-400/20 transition-colors duration-200 cursor-pointer landing-xs:text-sm landing-md:text-base block text-center no-underline"
              >
                Explore Elysian
              </a>
            </div>
          ...
          <div>
            <div className="flex flex-col items-center gap-2 landing-xs:mb-3 landing-md:mb-4">
              ...
              <span className="text-gray-300 landing-xs:text-base landing-md:text-lg text-center">
                Gain visibility with ElysianOps
              </span>
            </div>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (livePreviewSection) {
                    ...
                    window.dispatchEvent(new CustomEvent("activateElysianOpsTab"));
                  }
                }}
              >
                See ElysianOps in action
              </button>
            </div>
          </div>
        </div>
