...
export const OnboardingWidget = () => {
    ...
    const getCardPosition = () => {
        ...
        const cardWidth = 400; // Increased width to fit content nicely
        const cardHeight = 340; // Safely increased height to prevent bottom-cutoff offscreen
        const padding = 24;
    ...
    return (
        <AnimatePresence>
            ...
            <motion.div
                ...
                className="fixed bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 pointer-events-auto overflow-hidden w-full max-w-[400px]"
