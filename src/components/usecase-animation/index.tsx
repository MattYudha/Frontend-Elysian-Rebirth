        ...
        <div className="flex flex-col items-center relative">
          <div
            ...
            className={clsx(
              ...
              "border-[#0ea5e9] bg-[#0ea5e9]/10 shadow-[0_0_30px_rgba(0,217,146,0.3)]",
              "hover:scale-110",
          ...
          >
            ...
            {processing && (
              <>
                <div className="pointer-events-none absolute inset-0 rounded-full bg-[#0ea5e9] blur-md opacity-30 animate-[pulse_0.5s_ease-in-out_infinite]" />
                <div className="pointer-events-none absolute -inset-1 rounded-full border border-[#0ea5e9]/40 animate-[pulse_0.5s_ease-in-out_infinite]" />
              </>
            )}
          ...
          {label && (
            <span
              className={clsx(
                "mt-2 font-semibold text-[#0ea5e9]",
          ...
          {description && isHovered && (
            <div className="absolute top-full mt-2 z-50 w-48 rounded-md bg-[#082f49] border border-solid border-[#0369a1] p-3 shadow-lg text-xs text-gray-300">
              {description}
            </div>
          )}
        </div>
      ...
      <div className="relative">
        <div
          ...
          className={clsx(
            ...
            "hover:scale-105 hover:bg-[#0369a1]/30 hover:border-[#0ea5e9]/40",
            "px-3 py-2",
  ...
  return (
    ...
    >
      ...
      <div className="absolute" style={{ zIndex: 20 }}>
        <div className={clsx("transition-all duration-300")}>
          ...
          >
            <BoltIcon
              className={clsx(
                "text-[#0ea5e9] transition-all duration-300",
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full bg-[#0ea5e9]/5 blur-3xl" />
      </div>
    </div>
  );
});
