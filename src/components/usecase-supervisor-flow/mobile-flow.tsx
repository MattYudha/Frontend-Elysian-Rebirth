...
const nodeStyles = {
  ...
  supervisor:
    "border-solid border-[#0ea5e9]/60 text-[#0ea5e9] bg-[#0A0F15]/80 px-2 py-1.5 text-xs rounded-lg min-w-[70px] flex flex-col items-center justify-center shadow-[0_0_15px_rgba(0,217,146,0.3)]",
  agent:
    "border-solid border-sky-400/50 text-sky-300 bg-[#0A0F15]/80 px-2 py-1 text-[10px] rounded-lg min-w-[60px] flex flex-col items-center justify-center shadow-[0_0_10px_rgba(16,185,129,0.2)]",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[40%] left-[35%] -translate-x-1/2 -translate-y-1/2 w-[200px] h-[150px] rounded-full bg-[#0ea5e9]/15 blur-[80px]" />
        <div className="absolute top-[40%] left-[65%] -translate-x-1/2 -translate-y-1/2 w-[150px] h-[100px] rounded-full bg-[#0ea5e9]/10 blur-[60px]" />
      </div>
