...
export const translationsID: TranslationKeys = {
    ...
    landing: {
        ...
        agents: {
            ...
            title1: 'Biarkan AI Swarm Kami',
            title2: 'Melakukan Analisis Mendalam.',
            description: 'Ditenagai oleh arsitektur Multi-Agent, setiap agen AI MiroFish memiliki spesialisasi unik yang saling berkolaborasi untuk membedah, mengaudit, dan memvalidasi draf RAPBD dengan akurasi tinggi.',
            demo: {
                assign: 'Proses Audit...',
        ...
        collaboration: {
            badge: 'Autonomous Oversight',
            title1: 'Pengawasan Finansial',
            title2: 'Tanpa Celah Tersisa.',
            description: 'Memadukan miliaran data historis pengadaan, ekstraksi regulasi hukum, dan kecerdasan agen otonom untuk menjamin tidak ada satupun indikasi markup yang lolos dari pantauan.',
            cards: {
                project: {
